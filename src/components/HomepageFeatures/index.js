          ...
          <div className={styles.heroContent}>
            <div className={styles.textContainer}>
              <h1 className={styles.welcomeText}>
                Welcome to <span className={styles.shekharText}>Pradnyesh's</span> Channel
              </h1>
              <p className={styles.descriptionText}>
                Full Stack Engineer based in Pune with 4+ years of experience in Rails, Docker, Kubernetes, and Ruby.
